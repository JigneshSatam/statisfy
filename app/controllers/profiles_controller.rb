class ProfilesController < ApplicationController
  def index
    ...
    if fname_or_email.present?
      profiles = Profile.where("first_name ilike :fname_or_email OR last_name ilike :lname OR email ilike :fname_or_email", {fname_or_email: fname_or_email, lname: lname}).order(:first_name)
    else
